...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      waiverFeeCents: 4500,
      tiers: [
        { label: "Weekend (3 days)", days: 3, priceCents: 14900 },
        { label: "Week (7 days)", days: 7, priceCents: 24900 },
        { label: "Two weeks", days: 14, priceCents: 39900 },
      ],
    },
    {
      slug: "diamond-tiara",
      ...
      rentFixedCents: 49900,
      rentFixedDurationDays: 4,
      rentCopiesCount: 1,
      waiverFeeCents: 9900,
    },
  ];
